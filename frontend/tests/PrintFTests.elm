...
floatPrecisionTests =
    ...
    , test "Positive with 2 decimals of precision" <| \_ -> Expect.equal "10.02" <| formatFloat 10.02 2
    , test "Positive with 2 decimals of precision" <| \_ -> Expect.equal "10.03" <| formatFloat 10.03 2

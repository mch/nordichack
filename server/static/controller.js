...
var _user$project$Model$initDataModel = {
	heartdata: {heartrate: _elm_lang$core$Maybe$Nothing, rrInterval: _elm_lang$core$Maybe$Nothing, eventTime: _elm_lang$core$Maybe$Nothing},
	rrIntervalTimeSeries: {ctor: '[]'},
	heartRateSeries: {ctor: '[]'}
};
var _user$project$Model$DataModel = F3(
	function (a, b, c) {
		return {heartdata: a, rrIntervalTimeSeries: b, heartRateSeries: c};
	});
var _user$project$Model$HeartData = F3(
	function (a, b, c) {
		return {heartrate: a, rrInterval: b, eventTime: c};
	});

var _user$project$Ant$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{ctor: '[]'});
};
var _user$project$Ant$decodeHeartData = function (json) {
	var decoder = A4(
		_elm_lang$core$Json_Decode$map3,
		_user$project$Model$HeartData,
		_elm_lang$core$Json_Decode$maybe(
			A2(_elm_lang$core$Json_Decode$field, 'heartrate_bpm', _elm_lang$core$Json_Decode$int)),
		_elm_lang$core$Json_Decode$maybe(
			A2(_elm_lang$core$Json_Decode$field, 'rr_interval_ms', _elm_lang$core$Json_Decode$int)),
		_elm_lang$core$Json_Decode$maybe(
			A2(_elm_lang$core$Json_Decode$field, 'event_time_s', _elm_lang$core$Json_Decode$float)));
	var heartdata = A2(
		_elm_lang$core$Result$withDefault,
		{heartrate: _elm_lang$core$Maybe$Nothing, rrInterval: _elm_lang$core$Maybe$Nothing, eventTime: _elm_lang$core$Maybe$Nothing},
		A2(_elm_lang$core$Json_Decode$decodeString, decoder, json));
	return heartdata;
};
var _user$project$Ant$update = F2(
	function (action, model) {
		...
		return {
			...
			_2: _user$project$Ant$decodeHeartData(_p1)
		};
	});
var _user$project$Ant$init = function (hostname) {
	return {
		ctor: '_Tuple2',
		_0: {heartrate: 'NA', hostname: hostname},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Ant$Model = F2(
	function (a, b) {
		return {heartrate: a, hostname: b};
	});
var _user$project$Ant$Heartrate = function (a) {
	return {ctor: 'Heartrate', _0: a};
};
var _user$project$Ant$subscriptions = function (model) {
	return A2(
		_elm_lang$websocket$WebSocket$listen,
		A2(
			_elm_lang$core$Basics_ops['++'],
			'ws://',
			A2(_elm_lang$core$Basics_ops['++'], model.hostname, ':5000/heartrate')),
		_user$project$Ant$Heartrate);
};

var _user$project$Common$AntScreen = {ctor: 'AntScreen'};
var _user$project$Common$WorkoutListScreen = {ctor: 'WorkoutListScreen'};
var _user$project$Common$ControlPanelScreen = {ctor: 'ControlPanelScreen'};
var _user$project$Common$MainMenuScreen = {ctor: 'MainMenuScreen'};
var _user$project$Common$ChangeScreen = function (a) {
	return {ctor: 'ChangeScreen', _0: a};
};

var _user$project$Workout$getCurrentSegments = F2(
	function (t, w) {
		var offsetList = A2(
			_elm_lang$core$List$append,
			A2(_elm_lang$core$List$drop, 1, w.segments),
			A2(
				_elm_lang$core$List$drop,
				_elm_lang$core$List$length(w.segments) - 1,
				w.segments));
		var zipped = A3(
			_elm_lang$core$List$map2,
			F2(
		...
		var indexList = A2(
			...
			F2(
				function (i, _p0) {
					var _p1 = _p0;
					return {ctor: '_Tuple3', _0: i, _1: _p1._0, _2: _p1._1};
				}),
			zipped);
		var endSegment = A2(
			_elm_lang$core$Maybe$withDefault,
			...
			_elm_lang$core$List$head(
				A2(
					...
					_elm_lang$core$List$length(w.segments) - 1,
					w.segments)));
		return (_elm_lang$core$Native_Utils.cmp(t, endSegment.startTime) > -1) ? _elm_lang$core$Maybe$Just(
			{
				ctor: '_Tuple3',
				_0: _elm_lang$core$List$length(w.segments) - 1,
				_1: endSegment,
				_2: endSegment
			}) : _elm_lang$core$List$head(
			A2(
				...
				function (_p2) {
					var _p3 = _p2;
					return (_elm_lang$core$Native_Utils.cmp(t, _p3._1.startTime) > -1) && (_elm_lang$core$Native_Utils.cmp(t, _p3._2.startTime) < 0);
				},
				indexList));
	});
var _user$project$Workout$getSpeed = F2(
	function (t, w) {
		var currentSegments = A2(_user$project$Workout$getCurrentSegments, t, w);
		var _p4 = currentSegments;
		if (_p4.ctor === 'Nothing') {
			return 0.0;
		} else {
			return _p4._0._1.speed;
		}
	});
var _user$project$Workout$getIndex = F2(
	function (t, w) {
		var currentSegments = A2(_user$project$Workout$getCurrentSegments, t, w);
		var _p5 = currentSegments;
		if (_p5.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
...
var _user$project$Workout$getSegment = F2(
	function (t, w) {
		var currentSegments = A2(_user$project$Workout$getCurrentSegments, t, w);
		var _p6 = currentSegments;
		if (_p6.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Just(_p6._0._1);
		}
	});
var _user$project$Workout$fromIntervalDuration = F5(
	function (title, description, id, initialSpeed, data) {
		var timeAndSpeed = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 0, _1: initialSpeed},
			_1: data
		};
		return {
			title: title,
			...
			segments: A2(
				...
				function (_p7) {
					var _p8 = _p7;
					return {startTime: _p8._0, speed: _p8._1};
				},
				timeAndSpeed)
		};
	});
var _user$project$Workout$WorkoutListModel = function (a) {
	return {workoutList: a};
};
var _user$project$Workout$Workout = F4(
	function (a, b, c, d) {
		return {title: a, description: b, workoutId: c, segments: d};
	});
var _user$project$Workout$WorkoutSegment = F2(
	function (a, b) {
		return {startTime: a, speed: b};
	});

var _user$project$PrintF$formatFloat = F2(
	function (f, precision) {
		var fractionalToString = F2(
			function (fractional, precision) {
				var positionToString = function (_p0) {
					var _p1 = _p0;
					var next = _p1._0 * 10;
					var position = _elm_lang$core$Basics$truncate(next);
					return {
						ctor: '_Tuple2',
						_0: next - _elm_lang$core$Basics$toFloat(position),
						_1: A2(
							_elm_lang$core$Basics_ops['++'],
							_p1._1,
				...
				var helper = F2(
					function (_p2, positions) {
						helper:
						while (true) {
							var _p3 = _p2;
							var _p5 = _p3._0;
							var _p4 = _p3._1;
							if (_elm_lang$core$Native_Utils.cmp(positions, 0) < 1) {
								return {ctor: '_Tuple2', _0: _p5, _1: _p4};
							} else {
								var _v2 = positionToString(
				...
				var _p6 = A2(
					helper,
					{ctor: '_Tuple2', _0: fractional, _1: ''},
					precision);
				var fractionalString = _p6._1;
				return fractionalString;
			});
		var integer_part = _elm_lang$core$Basics$floor(f);
		var fractional_part = f - _elm_lang$core$Basics$toFloat(integer_part);
		return (_elm_lang$core$Native_Utils.cmp(precision, 0) > 0) ? A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(integer_part),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'.',
				A2(fractionalToString, fractional_part, precision))) : _elm_lang$core$Basics$toString(integer_part);
	});
var _user$project$PrintF$epsilon = 2.220446049250313e-16;
var _user$project$PrintF$essentiallyEqual = F3(
	function (a, b, epsilon) {
		var t = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$abs(a),
			_elm_lang$core$Basics$abs(b)) > 0) ? _elm_lang$core$Basics$abs(b) : (_elm_lang$core$Basics$abs(a) * epsilon);
		return _elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$abs(a - b),
			t) < 1;
	});
var _user$project$PrintF$approximatelyEqual = F3(
	function (a, b, epsilon) {
		var t = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$abs(a),
			_elm_lang$core$Basics$abs(b)) < 0) ? _elm_lang$core$Basics$abs(b) : (_elm_lang$core$Basics$abs(a) * epsilon);
...
var _user$project$ControlPanel$formatSpeed = function (speed) {
	var firstPart = _elm_lang$core$Basics$floor(speed);
	var secondPart = _elm_lang$core$Basics$floor(
		(speed - _elm_lang$core$Basics$toFloat(firstPart)) * 10);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(firstPart),
		A2(
			_elm_lang$core$Basics_ops['++'],
			'.',
			_elm_lang$core$Basics$toString(secondPart)));
};
var _user$project$ControlPanel$formatDistance = function (d) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_user$project$PrintF$formatFloat, d, 3),
		' km');
};
var _user$project$ControlPanel$formatInt = function (n) {
	return (_elm_lang$core$Native_Utils.cmp(n, 10) < 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'0',
		_elm_lang$core$Basics$toString(n)) : _elm_lang$core$Basics$toString(n);
};
var _user$project$ControlPanel$formatTime = function (ms) {
	var hours = _elm_lang$core$Basics$floor(
		_elm_lang$core$Time$inHours(ms));
	var minutes = _elm_lang$core$Basics$floor(
		_elm_lang$core$Time$inMinutes(
			ms - (_elm_lang$core$Basics$toFloat(hours) * _elm_lang$core$Time$hour)));
	var seconds = _elm_lang$core$Basics$floor(
		_elm_lang$core$Time$inSeconds(
			(ms - (_elm_lang$core$Basics$toFloat(hours) * _elm_lang$core$Time$hour)) - (_elm_lang$core$Basics$toFloat(minutes) * _elm_lang$core$Time$minute)));
	var times = (_elm_lang$core$Native_Utils.cmp(hours, 0) > 0) ? {
		ctor: '::',
		_0: hours,
		_1: {
			ctor: '::',
	...
	return A2(
		_elm_lang$core$String$join,
		':',
		A2(_elm_lang$core$List$map, _user$project$ControlPanel$formatInt, times));
};
var _user$project$ControlPanel$viewCpanelWorkout = F3(
	function (speed, currentTime, workout) {
		var remainingSegments = function () {
			var _p0 = workout;
			if (_p0.ctor === 'Nothing') {
				return {ctor: '[]'};
			} else {
				return A2(
					_elm_lang$core$List$filter,
					function (s) {
						return _elm_lang$core$Native_Utils.cmp(s.startTime, currentTime) > -1;
					},
					_p0._0.segments);
			}
		}();
		var nextSegment = _elm_lang$core$List$head(remainingSegments);
		var nextSegmentInfo = function () {
			var _p1 = nextSegment;
			if (_p1.ctor === 'Nothing') {
				return {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('cpanel-readout'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: (_elm_lang$core$Native_Utils.cmp(speed, 0) > 0) ? _elm_lang$html$Html$text('Your workout has no end. Touch stop when you get tired.') : _elm_lang$html$Html$text('You did it!'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				};
				...
				var _p2 = _p1._0;
				return ((_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$List$length(remainingSegments),
					1) > 0) && (_elm_lang$core$Native_Utils.cmp(_p2.speed, 0) > 0)) ? {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('cpanel-workout'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_user$project$ControlPanel$formatSpeed(_p2.speed),
										' km/h'))),
							_1: {ctor: '[]'}
						}),
					_1: {
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'In: ',
										_user$project$ControlPanel$formatTime(_p2.startTime - currentTime))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('You are almost done!'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(_p3._0.title),
								_1: {ctor: '[]'}
							}),
						_1: nextSegmentInfo
					}),
...
var _user$project$ControlPanel$viewCpanelLap = function (model) {
	var _p4 = model.workout;
	if (_p4.ctor === 'Nothing') {
		return {
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('0:34'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$ControlPanel$stringifyError = function (error) {
	var _p5 = error;
	switch (_p5.ctor) {
		case 'BadUrl':
...
var _user$project$ControlPanel$controlPanelInit = {
	ctor: '_Tuple2',
	_0: {
		speed: 0,
		requestedSpeed: 0,
		...
		currentTime: 0.0,
		distance: 0.0,
		workout: _elm_lang$core$Maybe$Nothing,
		nextSegment: _elm_lang$core$Maybe$Nothing,
		error: '',
		log: {ctor: '[]'}
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$ControlPanel$initialSpeed = 2 * 5;
var _user$project$ControlPanel$max_speed_increment = 30 * 5;
var _user$project$ControlPanel$min_speed_increment = 2 * 5;
var _user$project$ControlPanel$validateRequestedSpeed = function (requestedSpeed) {
	return (_elm_lang$core$Native_Utils.eq(requestedSpeed, 0) || ((_elm_lang$core$Native_Utils.cmp(requestedSpeed, _user$project$ControlPanel$min_speed_increment) > -1) && (_elm_lang$core$Native_Utils.cmp(requestedSpeed, _user$project$ControlPanel$max_speed_increment) < 1))) ? _elm_lang$core$Maybe$Just(requestedSpeed) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$ControlPanel$speed_increment = 0.2;
var _user$project$ControlPanel$updateTimeAndDistance = F2(
	function (model, t) {
		var startTime = _elm_lang$core$Native_Utils.eq(model.startTime, 0) ? t : model.startTime;
		var timeStep = (_elm_lang$core$Native_Utils.cmp(model.startTime, 0) > 0) ? _elm_lang$core$Time$inHours(t - model.currentTime) : 0.0;
		return (_elm_lang$core$Native_Utils.cmp(model.speed, 0) > 0) ? _elm_lang$core$Native_Utils.update(
			model,
			{
				currentTime: t,
				startTime: startTime,
				distance: model.distance + ((_elm_lang$core$Basics$toFloat(model.speed) * _user$project$ControlPanel$speed_increment) * timeStep)
			}) : model;
	});
var _user$project$ControlPanel$checkForSpeedChange = F3(
	function (elapsedTime, nextSegmentId, workout) {
		var computeNextSpeed = function (w) {
			return _elm_lang$core$Basics$round(
				function (x) {
					return x / _user$project$ControlPanel$speed_increment;
				}(
					A2(_user$project$Workout$getSpeed, elapsedTime, w)));
		};
		var nextSpeed = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			A2(_elm_lang$core$Maybe$map, computeNextSpeed, workout));
		var compareSegmentIds = F2(
			function (c, n) {
				return (_elm_lang$core$Native_Utils.cmp(c, n) > -1) ? _elm_lang$core$Maybe$Just(nextSpeed) : _elm_lang$core$Maybe$Nothing;
			});
		var currentSegment = A2(
			_elm_lang$core$Maybe$andThen,
			_user$project$Workout$getIndex(elapsedTime),
			workout);
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$core$Maybe$Nothing,
			A3(_elm_lang$core$Maybe$map2, compareSegmentIds, currentSegment, nextSegmentId));
	});
var _user$project$ControlPanel$invalidSpeedErrorMessage = function (speed) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'Invalid speed ',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$ControlPanel$formatSpeed(
				_elm_lang$core$Basics$toFloat(speed) * _user$project$ControlPanel$speed_increment),
			' requested.'));
};
var _user$project$ControlPanel$getWorkoutSpeed = F2(
	function (w, model) {
		return _elm_lang$core$Basics$round(
			A2(_user$project$Workout$getSpeed, model.currentTime - model.startTime, w) / _user$project$ControlPanel$speed_increment);
	});
var _user$project$ControlPanel$viewCpanelReadout = F2(
	function (model, data) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('cpanel-readout-speed'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$ControlPanel$formatSpeed(
									_elm_lang$core$Basics$toFloat(model.speed) * _user$project$ControlPanel$speed_increment),
								' km/h')),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('cpanel-readout-time'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_user$project$ControlPanel$formatTime(model.currentTime - model.startTime)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('cpanel-readout-distance'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_user$project$ControlPanel$formatDistance(model.distance)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('cpanel-readout-item'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(_jystic$elm_font_awesome$FontAwesome$heartbeat, _elm_lang$core$Color$red, 20),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(
												A2(_elm_lang$core$Maybe$withDefault, 0, data.heartdata.heartrate))),
										_1: {
											ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('cpanel-readout-wide-item'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										...
										_1: {
											...
											_0: _elm_lang$html$Html$text(
												_elm_lang$core$Basics$toString(
													A2(_elm_lang$core$Maybe$withDefault, 0, data.heartdata.rrInterval))),
											_1: {
												ctor: '::',
...
var _user$project$ControlPanel$LogDataPoint = F2(
	function (a, b) {
		return {time: a, speed: b};
	});
var _user$project$ControlPanel$updateSpeed = F2(
	function (model, result) {
		var stopping = (!_elm_lang$core$Native_Utils.eq(model.speed, 0)) && _elm_lang$core$Native_Utils.eq(model.requestedSpeed, 0);
		var starting = _elm_lang$core$Native_Utils.eq(model.speed, 0) && (!_elm_lang$core$Native_Utils.eq(model.requestedSpeed, 0));
		var updateModel = starting ? _elm_lang$core$Native_Utils.update(
			model,
			{
				...
				log: {
					ctor: '::',
					_0: A2(_user$project$ControlPanel$LogDataPoint, 0.0, model.requestedSpeed),
					_1: {ctor: '[]'}
				}
			...
			model,
			{
				...
				log: {
					ctor: '::',
					_0: A2(_user$project$ControlPanel$LogDataPoint, model.currentTime - model.startTime, model.requestedSpeed),
					_1: model.log
				}
			});
		var _p6 = result;
		if (_p6.ctor === 'Ok') {
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					requestedSpeed: model.speed,
					error: _user$project$ControlPanel$stringifyError(_p6._0)
				});
		}
	});
var _user$project$ControlPanel$ControlPanelModel = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {speed: a, requestedSpeed: b, startTime: c, currentTime: d, distance: e, workout: f, nextSegment: g, error: h, log: i};
	});
var _user$project$ControlPanel$SpeedPreset = F2(
	function (a, b) {
		return {label: a, speed: b};
	});
var _user$project$ControlPanel$SaveLogResponse = function (a) {
	return {ctor: 'SaveLogResponse', _0: a};
};
var _user$project$ControlPanel$postLog = function (log) {
	var encodeEntry = function (e) {
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'time',
					_1: _elm_lang$core$Json_Encode$float(e.time)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'speed',
						_1: _elm_lang$core$Json_Encode$int(e.speed)
					},
					_1: {ctor: '[]'}
				}
			});
	};
	var encodedLog = _elm_lang$core$Json_Encode$list(
		A2(_elm_lang$core$List$map, encodeEntry, log));
	var req = _elm_lang$http$Http$request(
		{
			method: 'POST',
			headers: {ctor: '[]'},
			url: '/api/v1/runs',
			body: _elm_lang$http$Http$jsonBody(encodedLog),
			expect: _elm_lang$http$Http$expectString,
			timeout: _elm_lang$core$Maybe$Just(_elm_lang$core$Time$second * 2.5),
			withCredentials: false
		});
	return A2(
		_elm_lang$http$Http$send,
		function (r) {
			return _user$project$ControlPanel$SaveLogResponse(r);
		},
		req);
};
var _user$project$ControlPanel$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$ControlPanel$controlPanelSubscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 0.1, _user$project$ControlPanel$Tick);
};
var _user$project$ControlPanel$SetSpeedResponse = function (a) {
	return {ctor: 'SetSpeedResponse', _0: a};
};
var _user$project$ControlPanel$postSpeedChange = function (requestedSpeed) {
	var req = _elm_lang$http$Http$request(
		{
			method: 'POST',
			headers: {ctor: '[]'},
			...
			body: A2(
				...
				'text/plain',
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Basics$toFloat(requestedSpeed) * _user$project$ControlPanel$speed_increment)),
			expect: _elm_lang$http$Http$expectString,
			timeout: _elm_lang$core$Maybe$Just(_elm_lang$core$Time$second * 2.5),
			withCredentials: false
		});
	return A2(
		_elm_lang$http$Http$send,
		function (r) {
			return _user$project$ControlPanel$SetSpeedResponse(r);
		},
		req);
};
var _user$project$ControlPanel$increaseSpeed = function (model) {
	var requestedSpeed = (_elm_lang$core$Native_Utils.cmp(model.speed, _user$project$ControlPanel$min_speed_increment) < 0) ? _user$project$ControlPanel$min_speed_increment : (model.speed + 1);
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
			{requestedSpeed: requestedSpeed}),
		_1: _user$project$ControlPanel$postSpeedChange(requestedSpeed)
	};
};
var _user$project$ControlPanel$decreaseSpeed = function (model) {
	var requestedSpeed = _elm_lang$core$Native_Utils.eq(model.speed, _user$project$ControlPanel$min_speed_increment) ? 0 : (model.speed - 1);
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$ControlPanel$changeSpeed = F2(
		...
		return A2(
			_elm_lang$core$Maybe$withDefault,
			{
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						error: _user$project$ControlPanel$invalidSpeedErrorMessage(_user$project$ControlPanel$initialSpeed)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			},
			A2(
				...
				function (x) {
					return {
						ctor: '_Tuple2',
						_0: x,
						_1: _user$project$ControlPanel$postSpeedChange(x.requestedSpeed)
					};
				},
				A2(
					_elm_lang$core$Maybe$map,
					...
					_user$project$ControlPanel$validateRequestedSpeed(speed))));
	});
var _user$project$ControlPanel$controlPanelUpdate = F2(
	function (msg, model) {
		var _p7 = msg;
		switch (_p7.ctor) {
			case 'Start':
				var _p8 = model.workout;
				if (_p8.ctor === 'Nothing') {
					return A2(_user$project$ControlPanel$changeSpeed, model, _user$project$ControlPanel$initialSpeed);
				} else {
					return A2(
						_user$project$ControlPanel$changeSpeed,
						model,
						A2(_user$project$ControlPanel$getWorkoutSpeed, _p8._0, model));
				}
			case 'Stop':
				return A2(_user$project$ControlPanel$changeSpeed, model, 0);
			case 'IncreaseSpeed':
				return _user$project$ControlPanel$increaseSpeed(model);
			case 'DecreaseSpeed':
				return _user$project$ControlPanel$decreaseSpeed(model);
			case 'SetSpeed':
				return A2(_user$project$ControlPanel$changeSpeed, model, _p7._0);
			case 'SetSpeedResponse':
				var model2 = A2(_user$project$ControlPanel$updateSpeed, model, _p7._0);
				var cmd = _elm_lang$core$Native_Utils.eq(model2.speed, 0) ? _user$project$ControlPanel$postLog(
					_elm_lang$core$List$reverse(model2.log)) : _elm_lang$core$Platform_Cmd$none;
				return {ctor: '_Tuple2', _0: model2, _1: cmd};
			case 'Tick':
				var elapsedTime = model.currentTime - model.startTime;
				var nextSpeed = A3(_user$project$ControlPanel$checkForSpeedChange, elapsedTime, model.nextSegment, model.workout);
				var model2 = A2(_user$project$ControlPanel$updateTimeAndDistance, model, _p7._0);
				return A2(
					_elm_lang$core$Maybe$withDefault,
					{ctor: '_Tuple2', _0: model2, _1: _elm_lang$core$Platform_Cmd$none},
					A2(
						_elm_lang$core$Maybe$map,
						function (_p9) {
							var _p10 = _p9;
						...
						A2(
							_elm_lang$core$Maybe$map,
							_user$project$ControlPanel$changeSpeed(model),
							nextSpeed)));
			default:
				var _p12 = _p7._0;
				if (_p12.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								error: _user$project$ControlPanel$stringifyError(_p12._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _user$project$ControlPanel$SetSpeed = function (a) {
	return {ctor: 'SetSpeed', _0: a};
};
var _user$project$ControlPanel$viewCpanelPresetButtons = function () {
	var presetButton = F2(
		function (label, speed) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('cpanel-preset-button'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$ControlPanel$SetSpeed(speed)),
						_1: {ctor: '[]'}
					}
				},
				{
	...
	var presets = {
		ctor: '::',
		_0: A2(_user$project$ControlPanel$SpeedPreset, '2', 10),
		_1: {
			ctor: '::',
			_0: A2(_user$project$ControlPanel$SpeedPreset, '4', 20),
			_1: {
				ctor: '::',
				_0: A2(_user$project$ControlPanel$SpeedPreset, '6', 30),
				_1: {
					ctor: '::',
					_0: A2(_user$project$ControlPanel$SpeedPreset, '8', 40),
					_1: {
						ctor: '::',
						_0: A2(_user$project$ControlPanel$SpeedPreset, '10', 50),
						_1: {
							ctor: '::',
							_0: A2(_user$project$ControlPanel$SpeedPreset, '12', 60),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('cpanel-preset-buttons'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
			function (preset) {
				return A2(presetButton, preset.label, preset.speed);
			},
			presets));
}();
var _user$project$ControlPanel$DecreaseSpeed = {ctor: 'DecreaseSpeed'};
var _user$project$ControlPanel$IncreaseSpeed = {ctor: 'IncreaseSpeed'};
var _user$project$ControlPanel$viewCpanelSpeedButtons = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('cpanel-speed-buttons'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('cpanel-button'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$ControlPanel$IncreaseSpeed),
					_1: {ctor: '[]'}
				}
			},
			{
		...
		_1: {
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$ControlPanel$DecreaseSpeed),
						_1: {ctor: '[]'}
					}
				},
				{
...
var _user$project$ControlPanel$Stop = {ctor: 'Stop'};
var _user$project$ControlPanel$Start = {ctor: 'Start'};
var _user$project$ControlPanel$viewCpanelStartStopButtons = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('cpanel-start-stop-buttons'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('cpanel-start-button'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$ControlPanel$Start),
					_1: {ctor: '[]'}
				}
			},
			{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('cpanel-stop-button'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$ControlPanel$Stop),
						_1: {ctor: '[]'}
					}
				},
				{
...
var _user$project$ControlPanel$controlPanelView = F2(
	function (model, dataModel) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('cpanel'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$append,
				{
					ctor: '::',
					_0: A2(_user$project$ControlPanel$viewCpanelReadout, model, dataModel),
					_1: A3(_user$project$ControlPanel$viewCpanelWorkout, model.requestedSpeed, model.currentTime - model.startTime, model.workout)
				},
				{
					ctor: '::',
					_0: _user$project$ControlPanel$viewCpanelSpeedButtons,
					_1: {
						ctor: '::',
						_0: _user$project$ControlPanel$viewCpanelPresetButtons,
						_1: {
							ctor: '::',
							_0: _user$project$ControlPanel$viewCpanelStartStopButtons,
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
...
var _user$project$WorkoutData$paceToSpeed = function (pace) {
	return (1.0 / pace) * 60.0;
};
var _user$project$WorkoutData$workoutListInit = {
	workoutList: {
		ctor: '::',
		_0: {
			title: 'Basic',
			...
			segments: {
				ctor: '::',
				_0: {startTime: 0, speed: 4},
				_1: {
					ctor: '::',
					_0: {startTime: _elm_lang$core$Time$minute * 2, speed: 8},
					_1: {
						ctor: '::',
						_0: {startTime: _elm_lang$core$Time$minute * 28, speed: 4},
						_1: {
							ctor: '::',
							_0: {startTime: _elm_lang$core$Time$minute * 30, speed: 0},
							_1: {ctor: '[]'}
						}
					}
				}
		...
		_1: {
			...
			_0: {
				title: 'C5K Week 1',
				workoutId: 1,
				description: _elm_lang$core$Maybe$Just('Brisk five-minute warmup walk. Then alternate 60 seconds of jogging and 90 seconds of walking for a total of 20 minutes.'),
				segments: {
					ctor: '::',
					_0: {startTime: 0, speed: 4},
					_1: {
						ctor: '::',
						_0: {startTime: _elm_lang$core$Time$minute * 5, speed: 8},
						_1: {
							ctor: '::',
							_0: {startTime: (_elm_lang$core$Time$minute * 5) + (_elm_lang$core$Time$second * 60), speed: 2},
							_1: {
								ctor: '::',
								_0: {startTime: _elm_lang$core$Time$minute * 7, speed: 0},
								_1: {ctor: '[]'}
							}
						}
					}
			...
			_1: {
				...
				_0: {
					title: 'Very Short',
					workoutId: 2,
					description: _elm_lang$core$Maybe$Just('Test'),
					segments: {
						ctor: '::',
						_0: {startTime: 0, speed: 4},
						_1: {
							ctor: '::',
							_0: {startTime: _elm_lang$core$Time$second * 5, speed: 8},
							_1: {
								ctor: '::',
								_0: {startTime: _elm_lang$core$Time$second * 10, speed: 0},
								_1: {ctor: '[]'}
							}
						}
					}
				...
				_1: {
					...
					_0: {
						...
						workoutId: 3,
						description: _elm_lang$core$Maybe$Just('Build your endurance for the race'),
						segments: {
							ctor: '::',
							_0: {
								startTime: 0,
								speed: _user$project$WorkoutData$paceToSpeed(7.0)
							},
							_1: {
								ctor: '::',
								_0: {startTime: _elm_lang$core$Time$minute * 40, speed: 0},
								_1: {ctor: '[]'}
							}
						}
					},
					_1: {
						...
						_0: {
							...
							workoutId: 4,
							description: _elm_lang$core$Maybe$Just('Primary fitness building workout'),
							segments: {
								ctor: '::',
								_0: {
									startTime: 0,
								...
								_1: {
									ctor: '::',
									_0: {
										startTime: _elm_lang$core$Time$minute * 10,
										speed: _user$project$WorkoutData$paceToSpeed(5.0)
									},
									_1: {
										ctor: '::',
										_0: {
											startTime: _elm_lang$core$Time$minute * 11,
											speed: _user$project$WorkoutData$paceToSpeed(7.0)
										},
										_1: {
											ctor: '::',
											_0: {
												startTime: _elm_lang$core$Time$minute * 12,
												speed: _user$project$WorkoutData$paceToSpeed(5.0)
											},
											_1: {
												ctor: '::',
												_0: {
													startTime: _elm_lang$core$Time$minute * 13,
													speed: _user$project$WorkoutData$paceToSpeed(7.0)
												},
												_1: {
													ctor: '::',
													_0: {
														startTime: _elm_lang$core$Time$minute * 14,
														speed: _user$project$WorkoutData$paceToSpeed(5.0)
													},
													_1: {
														ctor: '::',
														_0: {
															startTime: _elm_lang$core$Time$minute * 15,
															speed: _user$project$WorkoutData$paceToSpeed(7.0)
														},
														_1: {
															ctor: '::',
															_0: {
																startTime: _elm_lang$core$Time$minute * 16,
																speed: _user$project$WorkoutData$paceToSpeed(5.0)
															},
															_1: {
																ctor: '::',
																_0: {
																	startTime: _elm_lang$core$Time$minute * 17,
																	speed: _user$project$WorkoutData$paceToSpeed(7.0)
																},
																_1: {
																	ctor: '::',
																	_0: {
																		startTime: _elm_lang$core$Time$minute * 18,
																		speed: _user$project$WorkoutData$paceToSpeed(5.0)
																	},
																	_1: {
																		ctor: '::',
																		_0: {
																			startTime: _elm_lang$core$Time$minute * 19,
																			speed: _user$project$WorkoutData$paceToSpeed(7.0)
																		},
																		_1: {
																			ctor: '::',
																			_0: {
																				startTime: _elm_lang$core$Time$minute * 20,
																				speed: _user$project$WorkoutData$paceToSpeed(5.0)
																			},
																			_1: {
																				ctor: '::',
																				_0: {
																					startTime: _elm_lang$core$Time$minute * 21,
																					speed: _user$project$WorkoutData$paceToSpeed(7.0)
																				},
																				_1: {
																					ctor: '::',
																					_0: {
																						startTime: _elm_lang$core$Time$minute * 22,
																						speed: _user$project$WorkoutData$paceToSpeed(5.0)
																					},
																					_1: {
																						ctor: '::',
																						_0: {
																							startTime: _elm_lang$core$Time$minute * 23,
																							speed: _user$project$WorkoutData$paceToSpeed(7.0)
																						},
																						_1: {
																							ctor: '::',
																							_0: {
																								startTime: _elm_lang$core$Time$minute * 24,
																								speed: _user$project$WorkoutData$paceToSpeed(5.0)
																							},
																							_1: {
																								ctor: '::',
																								_0: {
																									startTime: _elm_lang$core$Time$minute * 25,
																									speed: _user$project$WorkoutData$paceToSpeed(7.0)
																								},
																								_1: {
																									ctor: '::',
																									_0: {
																										startTime: _elm_lang$core$Time$minute * 26,
																										speed: _user$project$WorkoutData$paceToSpeed(5.0)
																									},
																									_1: {
																										ctor: '::',
																										_0: {
																											startTime: _elm_lang$core$Time$minute * 27,
																											speed: _user$project$WorkoutData$paceToSpeed(7.0)
																										},
																										_1: {
																											ctor: '::',
																											_0: {
																												startTime: _elm_lang$core$Time$minute * 28,
																												speed: _user$project$WorkoutData$paceToSpeed(5.0)
																											},
																											_1: {
																												ctor: '::',
																												_0: {
																													startTime: _elm_lang$core$Time$minute * 29,
																													speed: _user$project$WorkoutData$paceToSpeed(7.0)
																												},
																												_1: {
																													ctor: '::',
																													_0: {startTime: _elm_lang$core$Time$minute * 45, speed: 0.0},
																													_1: {ctor: '[]'}
																												}
																											}
																										}
						...
						_1: {
							...
							_0: {
								...
								segments: {
									...
									_1: {
										ctor: '::',
										_0: {startTime: _elm_lang$core$Time$minute * 60, speed: 0},
										_1: {ctor: '[]'}
									}
								}
							},
							_1: {
								...
								_0: {
									...
									workoutId: 6,
									description: _elm_lang$core$Maybe$Just('Build a well of strength'),
									segments: {
										ctor: '::',
										_0: {
											startTime: 0,
								...
								_1: {
									...
									_0: {
										...
										workoutId: 7,
										description: _elm_lang$core$Maybe$Just('Another pace change workout to build mental toughness'),
										segments: {
											ctor: '::',
											_0: {
												startTime: 0,
																			...
																			_1: {
																				...
																				_1: {
																					...
																					_1: {
																						ctor: '::',
																						_0: {
																							startTime: _elm_lang$core$Time$minute * 30,
																							speed: _user$project$WorkoutData$paceToSpeed(5.0)
																						},
																						_1: {
																							ctor: '::',
																							_0: {
																								startTime: _elm_lang$core$Time$minute * 32,
																								speed: _user$project$WorkoutData$paceToSpeed(7.0)
																							},
																							_1: {
																								ctor: '::',
																								_0: {startTime: _elm_lang$core$Time$minute * 50, speed: 0.0},
																								_1: {ctor: '[]'}
																							}
																						}
																					}
									...
									_1: {
										...
										_0: {
											...
											segments: {
												...
												_1: {
													ctor: '::',
													_0: {startTime: _elm_lang$core$Time$minute * 75, speed: 0},
													_1: {ctor: '[]'}
												}
											}
										},
										_1: {
											...
											_1: {
												...
												_0: {
													...
													workoutId: 10,
													description: _elm_lang$core$Maybe$Just('Improve lactate threshold'),
													segments: {
														ctor: '::',
														_0: {
															startTime: 0,
														...
														_1: {
															...
															_0: {
																startTime: _elm_lang$core$Time$minute * 10,
																speed: _user$project$WorkoutData$paceToSpeed(6.5)
															},
															_1: {
																ctor: '::',
																_0: {startTime: _elm_lang$core$Time$minute * 40, speed: 7.0},
																_1: {
																	ctor: '::',
																	_0: {startTime: _elm_lang$core$Time$minute * 55, speed: 7.0},
																	_1: {ctor: '[]'}
																}
															}
														}
												...
												_1: {
													...
													_0: {
														...
														workoutId: 11,
														description: _elm_lang$core$Maybe$Just('Control effort early to finish strong'),
														segments: {
															ctor: '::',
															_0: {
																startTime: 0,
															...
															_1: {
																ctor: '::',
																_0: {
																	startTime: _elm_lang$core$Time$minute * 60,
																	speed: _user$project$WorkoutData$paceToSpeed(5.5)
																},
																_1: {
																	ctor: '::',
																	_0: {startTime: _elm_lang$core$Time$minute * 70, speed: 0.0},
																	_1: {ctor: '[]'}
																}
															}
														}
...
var _user$project$Main$workoutListUpdate = F2(
	function (msg, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {controlPanel: a, workoutList: b, antModel: c, currentScreen: d, dataModel: e};
	});
var _user$project$Main$Flags = function (a) {
	return {hostname: a};
};
var _user$project$Main$AntMsg = function (a) {
	return {ctor: 'AntMsg', _0: a};
};
var _user$project$Main$EditWorkout = function (a) {
	return {ctor: 'EditWorkout', _0: a};
};
var _user$project$Main$StartWorkout = function (a) {
	return {ctor: 'StartWorkout', _0: a};
};
var _user$project$Main$viewWorkout = function (workout) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('workout-list-item'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$StartWorkout(
						_elm_lang$core$Maybe$Just(workout))),
				_1: {ctor: '[]'}
			}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(workout.title),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('workout-list-item-edit'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Main$EditWorkout(workout.workoutId)),
							_1: {ctor: '[]'}
						}
					},
					{
...
var _user$project$Main$viewWorkoutListItem = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('workout-list'),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$map, _user$project$Main$viewWorkout, model.workoutList));
};
var _user$project$Main$ChangeScreen = function (a) {
	return {ctor: 'ChangeScreen', _0: a};
};
var _user$project$Main$viewMainMenu = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('mainmenu'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$ChangeScreen(_user$project$Common$ControlPanelScreen)),
					_1: {ctor: '[]'}
				}
			},
			{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$ChangeScreen(_user$project$Common$WorkoutListScreen)),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Workouts'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Run History'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Training Schedule'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$div,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Main$ChangeScreen(_user$project$Common$AntScreen)),
											_1: {ctor: '[]'}
										}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('ANT+ Devices'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Main$ControlPanelMsg = function (a) {
	return {ctor: 'ControlPanelMsg', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	var antSubs = A2(
		_elm_lang$core$Platform_Sub$map,
		_user$project$Main$AntMsg,
		_user$project$Ant$subscriptions(model.antModel));
	var cpanelSubs = A2(
		_elm_lang$core$Platform_Sub$map,
		_user$project$Main$ControlPanelMsg,
		_user$project$ControlPanel$controlPanelSubscriptions(model.controlPanel));
...
var _user$project$Main$init = function (flags) {
	var _p0 = _user$project$Ant$init(flags.hostname);
	var antModel = _p0._0;
	var antCmd = _p0._1;
	var _p1 = {ctor: '_Tuple2', _0: _user$project$WorkoutData$workoutListInit, _1: _elm_lang$core$Platform_Cmd$none};
	var wlm = _p1._0;
	var wlc = _p1._1;
	var _p2 = _user$project$ControlPanel$controlPanelInit;
	var cpm = _p2._0;
	var cpc = _p2._1;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{controlPanel: cpm, workoutList: wlm, currentScreen: _user$project$Common$MainMenuScreen, antModel: antModel, dataModel: _user$project$Model$initDataModel},
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ControlPanelMsg, cpc),
			_1: {
				ctor: '::',
				_0: wlc,
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$AntMsg, antCmd),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'ControlPanelMsg':
				var _p4 = A2(_user$project$ControlPanel$controlPanelUpdate, _p3._0, model.controlPanel);
				var cpm = _p4._0;
				var cpc = _p4._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{controlPanel: cpm}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ControlPanelMsg, cpc)
				};
			case 'ChangeScreen':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentScreen: _p3._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'StartWorkout':
				var _p5 = _user$project$ControlPanel$controlPanelInit;
				var freshCpModel = _p5._0;
				var cpModel = model.controlPanel;
				return (_elm_lang$core$Native_Utils.eq(model.controlPanel.speed, 0) && _elm_lang$core$Native_Utils.eq(model.controlPanel.requestedSpeed, 0)) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentScreen: _user$project$Common$ControlPanelScreen,
							controlPanel: _elm_lang$core$Native_Utils.update(
								freshCpModel,
								{
									workout: _p3._0,
									nextSegment: _elm_lang$core$Maybe$Just(1)
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : {
			...
			default:
				...
				var _p6 = A2(_user$project$Ant$update, _p3._0, model.antModel);
				var newModel = _p6._0;
				var newCmd = _p6._1;
				var heartdata = _p6._2;
				var nextRRInterval = A2(
					_elm_lang$core$Maybe$withDefault,
					{ctor: '[]'},
					A2(
						_elm_lang$core$Maybe$map,
						...
						A3(
							...
							heartdata.eventTime,
							heartdata.rrInterval)));
				var nextHeartRate = A2(
					_elm_lang$core$Maybe$withDefault,
					{ctor: '[]'},
					A2(
						_elm_lang$core$Maybe$map,
				...
				var newDataModel = _elm_lang$core$Native_Utils.update(
					...
					{
						heartdata: heartdata,
						rrIntervalTimeSeries: A2(_elm_lang$core$List$append, dataModel.rrIntervalTimeSeries, nextRRInterval),
						heartRateSeries: A2(_elm_lang$core$List$append, dataModel.heartRateSeries, nextHeartRate)
					});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{antModel: newModel, dataModel: newDataModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$AntMsg, newCmd)
				};
		}
	});
var _user$project$Main$view = function (model) {
	var content = function () {
		var _p7 = model.currentScreen;
		switch (_p7.ctor) {
			case 'ControlPanelScreen':
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Main$ControlPanelMsg,
					A2(_user$project$ControlPanel$controlPanelView, model.controlPanel, model.dataModel));
			case 'WorkoutListScreen':
				return _user$project$Main$viewWorkoutListItem(model.workoutList);
			case 'MainMenuScreen':
				return _user$project$Main$viewMainMenu;
			default:
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Main$AntMsg,
					_user$project$Ant$view(model.dataModel));
		}
	}();
	var screenTitle = A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('screen-title'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('NordicHack'),
			_1: {ctor: '[]'}
		});
	var backButton = A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$ChangeScreen(_user$project$Common$MainMenuScreen)),
				_1: {ctor: '[]'}
			}
		},
		{
	...
	var navbar = _elm_lang$core$Native_Utils.eq(model.currentScreen, _user$project$Common$MainMenuScreen) ? {
		ctor: '::',
		_0: screenTitle,
		_1: {ctor: '[]'}
	} : {
...
var Elm = {};
Elm['Ant'] = Elm['Ant'] || {};
if (typeof _user$project$Ant$main !== 'undefined') {
    _user$project$Ant$main(Elm['Ant'], 'Ant', undefined);
}
Elm['Common'] = Elm['Common'] || {};
if (typeof _user$project$Common$main !== 'undefined') {
    _user$project$Common$main(Elm['Common'], 'Common', undefined);
}
Elm['ControlPanel'] = Elm['ControlPanel'] || {};
if (typeof _user$project$ControlPanel$main !== 'undefined') {
    _user$project$ControlPanel$main(Elm['ControlPanel'], 'ControlPanel', undefined);
}
Elm['Main'] = Elm['Main'] || {};
...
Elm['PrintF'] = Elm['PrintF'] || {};
if (typeof _user$project$PrintF$main !== 'undefined') {
    _user$project$PrintF$main(Elm['PrintF'], 'PrintF', undefined);
}
Elm['Workout'] = Elm['Workout'] || {};
if (typeof _user$project$Workout$main !== 'undefined') {
    _user$project$Workout$main(Elm['Workout'], 'Workout', undefined);
}
Elm['WorkoutData'] = Elm['WorkoutData'] || {};
if (typeof _user$project$WorkoutData$main !== 'undefined') {
    _user$project$WorkoutData$main(Elm['WorkoutData'], 'WorkoutData', undefined);
}
